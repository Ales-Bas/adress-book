        ...
        <div className="flex flex-col items-center justify-center container py-10">
            ...
            <div className="justify-start w-full mx-32 py-5">
                ...
                <ul>
                    ...
                    <li className="py-2">
                        3. Добавлено удаление компаний и отделов в панель администратора
                        <div className="ml-4">Удаление компаний или отделов, работает только если в них нет записей.</div>
                    </li>
                    <li className="py-2">
